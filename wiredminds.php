                ...
                <form action="" method="post">
                    <div class="postbox">
						...
						<div class="inside"><?php
                        	...
                        	<?php } ?>
							<p>
								<label style="width:200px;text-align:right; float:left; display:block; line-height: 30px;" for="wp_wm_custnum">Kundennummer (wm_custnum):</label>&nbsp;
								<input name="wp_wm_custnum" id="wp_wm_custnum" type="text" value="<?php
								    echo $wp_wm_custnum;
								?>" size="40"/>
							</p>
                            <p>
								<label style="width:200px;text-align:right; float:left; display:block; line-height: 30px;" for="wp_wm_cnt_server">Zählserver Domain:</label>&nbsp;
								https://<input name="wp_wm_cnt_server" id="wp_wm_cnt_server" type="text" value="<?php
